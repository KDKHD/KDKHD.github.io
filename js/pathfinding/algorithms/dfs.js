function depthFirstSearch(grid){
    ...
    this.sortOpen = function sortOpen(last){
        toSort = open.slice(open.length-last)
        origin = open.slice(0,open.length-last)

        sorted = this.mergeSort(toSort)
        origin.push(...sorted)
        open = origin
        //open = open
    }
